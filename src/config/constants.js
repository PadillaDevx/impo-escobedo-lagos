...
export const SERVICES_DATA = [
    {
        ...
        shortDescription: 'Gestionamos todo el proceso de comercio internacional para que tu mercancía llegue a tiempo y en perfectas condiciones.',
        fullDescription: 'Gestionamos todo el proceso de comercio internacional, desde la documentación hasta la entrega final de tu mercancía.',
        features: [
    ...
    },
    {
        ...
        shortDescription: 'Te guiamos en cada paso del proceso logístico, optimizando costos y tiempos de entrega para tu negocio.',
        fullDescription: 'Te acompañamos en cada etapa del proceso logístico con soluciones personalizadas para tu negocio.',
        features: [
    ...
    },
    {
        ...
        shortDescription: 'Expertos en regulaciones aduaneras, facilitamos el despacho de tu mercancía sin complicaciones.',
        fullDescription: 'Expertos en regulaciones aduaneras nacionales e internacionales para facilitar tus operaciones.',
        features: [
...
export const FOOTER_LINKS = {
    services: [
        { name: 'Importaciones', path: '/servicios' },
        { name: 'Exportaciones', path: '/servicios' },
        { name: 'Asesoría Logística', path: '/servicios' }
    ],
    company: [
        { name: 'Nosotros', path: '/nosotros' },
        { name: 'Noticias', path: '/blog' },
...
export const NEWS_CATEGORIES = ['Guías', 'Comercio', 'Logística', 'Tendencias', 'Noticias', 'General'];
